{
  ...
  'depends': ['base', 'project', 'website','web','kami_sm','helpdesk_mgmt', 'helpdesk_mgmt','helpdesk_mgmt_project','helpdesk_mgmt_rating','helpdesk_mgmt_sla','helpdesk_type'],
  'data': [
      ...
      'templates/kami_test.xml',
      'templates/type_view.xml'
  ],
  'installable': True,
  'auto_install': False,
  'application': False,
